...
$.fn.extend({
	photoMove:function (arr,json,time){	
		...
		var createElement=function (){
			var str= "";
			var str2= "";
			var css_style='<style>body,ul,li{margin:0;padding:0;list-style: none;} '+"#"+_that.attr("id")+'{position: relative;width: '+json["width"]+';height: '+json["height"]+';overflow: hidden;}#'+this_id+'_photo_container{position: relative;width:100%;height:100%;} #'+this_id+'_photo_container a{top:0;left: '+json["width"]+';position: absolute;width:100%;height: 100%;} #'+this_id+'_photo_container #'+this_id+'_photo_first{left: 0;} #'+this_id+'_photo_container a img{width:100%;height: 100%;} #'+this_id+'_photo_ul{position: absolute;width: 200px;bottom: 16px;left:50%;margin-left:-100px;text-align: center;} #'+this_id+'_photo_ul li{border-radius: 50%;height: 14px;width: 14px;margin: 0 4px;cursor: pointer;opacity: 0.9;filter:alpha(opacity=90);display: inline-block;*zoom: 1;*display: inline;} #'+this_id+'_photo_prev,#'+this_id+'_photo_next{position: absolute;width: 57px;height: 62px;cursor: pointer;display: none;opacity: 0.5} #'+this_id+'_photo_prev{left: 20%;top:50%;margin-top:-31px;background:url("images/prev.png")} #'+this_id+'_photo_next{right: 20%;top:50%;margin-top:-31px;background: url("images/next.png")}</style>';
		...
		var photoMove={
			...
			photoChange:function (flag){
				...
				$a.eq(this.current%_length).stop(true,true).animate({left:flag*$width},700);
				$a.eq(this.next%_length).css("left",-flag*$width).stop(true,true).animate({left:0},700);
			},
			doMove:function (){
